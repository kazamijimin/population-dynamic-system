      ...
      <div className="auth-shell">
        <section className="auth-showcase">
          ...
          <div className="auth-showcase-copy">
            <h1>
              Create a
              <span>team-ready workspace</span>
            </h1>
            <p>
              Set up administrators, managers, and staff with one consistent system for monitoring, simulation, and operational reporting.
            </p>
          </div>

          <div className="auth-showcase-bottom">
            <div className="auth-showcase-card">
              <div className="auth-showcase-card-label">Workspace setup</div>
              <div className="auth-showcase-card-value">3 roles</div>
        ...
        <div className="auth-box auth-box-large">
          ...
          <div className="auth-header">
            ...
            <p className="auth-subtitle">Register a new user and assign the right workspace role from the start.</p>
          </div>
